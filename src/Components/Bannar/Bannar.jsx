        ...
        <div className='container mx-auto relative mt-10 '>
            <section className=" rounded-3xl h-[500px] lg:h-full">
                ...
                <div className='absolute top-[10%] lg:top-[37%] left-[20%] w-[60%] space-y-5 lg:space-y-10'>
                    ...
                    <p className='text-center text-white'>Learn and Master Basic Programming, Data Structures, Algorithm, OOP, Database and solve 500+ coding problems to become an exceptionally well world-class Programmer.</p>
